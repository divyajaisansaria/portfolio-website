  ...
  return (
    ...
    >
      <div className="relative h-full transition-all duration-500 hover:-translate-y-1 cursor-pointer">
        ...
        <Card className="h-full rounded-xl border border-border/50 bg-card/20 backdrop-blur-sm hover:border-primary/30 transition-all duration-500 overflow-hidden">
          <CardContent className="p-7 flex flex-col h-full space-y-5">
            {/* Top Bar: Icon and Date */}
            <div className="flex items-start justify-between">
              <div className="p-2.5 bg-muted/20 border border-border/40 rounded-lg group-hover:border-primary/40 group-hover:bg-primary/[0.03] transition-all duration-500">
            ...
            <div className="flex-1 space-y-3">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                   {item.details?.rank && (
                    <span className="inline-flex items-center px-1.5 py-0.5 text-[9px] font-bold bg-primary/10 text-primary border border-primary/20 rounded-sm">
                      {item.details.rank}
                    </span>
                  )}
